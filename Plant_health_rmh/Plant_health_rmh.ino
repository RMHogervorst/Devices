...
#define NUMBER_OF_SENSORS 1                         // Sensor count. How many moisture sensors have you connected? The maximum is five.
...
void presentation()
{
  ...
  sendSketchInfo(F("Plant Health2"), F("1.0")); wait(RADIO_DELAY);
...
void setup()
{
  ...
  Serial.println(F("Hello, I am a plant health device2"));
